 ...
 */
class FCustomAssetEditorStyle : public FSlateStyleSet
{
public:

	/** Default constructor. */
	 FCustomAssetEditorStyle()
		 : FSlateStyleSet("CustomAssetEditorStyle")
	 {
		const FVector2D Icon16x16(16.0f, 16.0f);
		const FVector2D Icon20x20(20.0f, 20.0f);
		const FVector2D Icon40x40(40.0f, 40.0f);

		const FString BaseDir = IPluginManager::Get().FindPlugin("CustomAsset")->GetBaseDir();
